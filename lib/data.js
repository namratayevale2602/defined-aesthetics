...
export const services = [
  {
    ...
    description:
      "Achieve perfectly shaped brows every day with permanent eyebrows for a polished look. Each technique is customised to your facial structure, hair colour, and lifestyle for results that look completely natural.",
    ...
    faqs: [
      {
        ...
        answer:
          "Microblading is a semi-permanent eyebrow technique where a fine blade deposits pigment into the upper layers of the skin, creating realistic hair-stroke brows that last 12–18 months.",
      },
      {
        question: "Does eyebrow tattooing hurt?",
        answer:
          "A topical numbing cream is applied before the procedure, making it very comfortable. Most clients describe a mild scratching sensation at most.",
      },
      {
        question: "How long do permanent eyebrows last?",
        answer:
          "Depending on the technique and your skin type, permanent eyebrows last 1–3 years. A touch-up session is recommended at 4–6 weeks after the initial procedure.",
      },
      {
        question: "What is the healing time for microblading?",
        answer:
          "The initial healing takes 7–14 days. During this time the brows may appear darker and slightly raised before settling into their final colour.",
      },
      {
        question: "Can I choose my brow shape?",
        answer:
          "Absolutely. Every client receives a full brow mapping and design consultation before the procedure begins. You approve the shape before any pigment is applied.",
      },
    ],
  },
  {
    ...
    description:
      "Enhance your natural lip colour, correct dark pigmentation, and achieve the perfect pout that lasts. From natural nudes to bold shades — customised entirely to your preference.",
    ...
    faqs: [
      {
        ...
        answer:
          "Lip blush is a semi-permanent cosmetic tattoo that adds colour, definition, and the illusion of fuller lips. The result is a natural, watercolour-like tint that lasts 1–2 years.",
      },
      {
        question: "Can dark lips be treated?",
        answer:
          "Yes! Our Dark Neutralisation technique is specifically designed for hyperpigmented lips. It uses colour theory to neutralise darkness before layering a beautiful natural shade on top.",
      },
      {
        question: "Is lip blush painful?",
        answer:
          "A strong topical numbing cream is applied before and during the procedure. Most clients find it very manageable — the lips are one of the most effectively numbed areas.",
      },
      {
        question: "How long does lip blush last?",
        answer:
          "Lip blush typically lasts 1–2 years depending on your lifestyle, sun exposure, and skin type. A touch-up at 6–8 weeks after the first session perfects the result.",
      },
      {
        question: "Will my lips look overdone?",
        answer:
          "Never. We work with you to choose a shade that complements your natural colouring. The healed result is always softer and more natural than it appears immediately after the procedure.",
      },
    ],
  },
  {
    ...
    description:
      "A non-surgical, permanent solution for hair thinning, receding hairlines, and baldness. SMP creates the illusion of a full head of hair using micro-pigment deposits on the scalp.",
    ...
    faqs: [
      {
        ...
        answer:
          "Scalp micropigmentation (SMP) is a non-surgical cosmetic treatment where natural pigments are applied at the epidermal level of the scalp to replicate the natural appearance of hair follicles.",
      },
      {
        question: "Is SMP suitable for women?",
        answer:
          "Yes. SMP is highly effective for women experiencing hair thinning, alopecia, or scalp scarring. It creates the appearance of density without affecting existing hair.",
      },
      {
        question: "How long does SMP last?",
        answer:
          "SMP typically lasts 3–5 years before a touch-up is needed. The longevity depends on sun exposure, skincare routine, and individual skin characteristics.",
      },
      {
        question: "Does it look natural?",
        answer:
          "When performed by a skilled artist, SMP is virtually indistinguishable from real hair follicles. We precisely match pigment tone to your natural hair colour for the most realistic result.",
      },
    ],
  },
  {
    ...
    description:
      "Add a touch of elegance with a precisely placed permanent beauty spot. A subtle, timeless accent that enhances your natural features and adds a classic, iconic charm to your look.",
    image: "/images/definedcard.png",
    techniques: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Beauty spot making is a cosmetic tattoo procedure where a small, precise dot of pigment is deposited into the skin to create a permanent or semi-permanent beauty mark at a location of your choice.",
      },
      {
        question: "How long does a beauty spot last?",
        answer:
          "A permanent beauty spot typically lasts 1–3 years depending on skin type and sun exposure. The colour gradually fades naturally over time.",
      },
      {
        question: "Where can a beauty spot be placed?",
        answer:
          "The most popular placements are near the upper lip (Marilyn Monroe style), on the cheek, or near the eye. We work with your facial structure to find the most flattering placement.",
      },
    ],
  },
];
...
export const blogPosts = [
  {
    ...
    excerpt:
      "Not sure which eyebrow technique suits your skin and lifestyle best? Here's everything you need to know to make the right choice.",
    date: "2024-12-15",
    readTime: "5 min",
    category: "Eyebrows",
    tags: ["microblading", "ombre brows", "eyebrow techniques"],
    content: [
      {
        type: "intro",
  ...
  },
  {
    ...
    excerpt:
      "Dark, pigmented lips are incredibly common in Indian skin tones. Learn how permanent lip neutralisation can transform your lips naturally.",
    date: "2024-11-28",
    readTime: "6 min",
    category: "Lip Blush",
    tags: ["lip blush", "dark lips", "lip neutralisation", "Indian skin"],
    content: [
      {
        type: "intro",
  ...
  },
  {
    ...
    excerpt:
      "The healing process is crucial for perfect results. Follow this day-by-day guide to ensure your brows heal beautifully.",
    date: "2024-11-10",
    readTime: "7 min",
    category: "Aftercare",
    tags: ["microblading", "aftercare", "healing", "eyebrows"],
    content: [
      {
        type: "intro",
  ...
  },
  {
    ...
    excerpt:
      "SMP is transforming lives for people experiencing hair loss. Discover how this non-surgical treatment works and who it's best for.",
    date: "2024-10-20",
    readTime: "5 min",
    category: "Scalp",
    tags: ["scalp micropigmentation", "SMP", "hair loss", "hairline"],
    content: [
      {
        type: "intro",
  ...
  },
  {
    ...
    excerpt:
      "Indian skin tones require specific pigment knowledge for beautiful lip blush results. Here's what makes our approach different.",
    date: "2024-09-30",
    readTime: "4 min",
    category: "Lip Blush",
    tags: ["lip blush", "Indian skin", "pigmentation", "lip colour"],
    content: [
      {
        type: "intro",
...
export const navItems = [
  ...
  { label: "About", href: "/about" },
  {
    ...
    href: "/services",
    dropdown: [
      { label: "Permanent Eyebrows", href: "/services/eyebrows" },
      { label: "Lip Blush", href: "/services/lip-blush" },
      { label: "Scalp Micropigmentation", href: "/services/scalp-micropigmentation" },
      { label: "Beauty Spot Making", href: "/services/beauty-spot" },
    ],
  },
